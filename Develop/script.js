...
var generate = function() {
    ...
    var upper = confirm("Would you like the password to include uppercase characters? (Q,W,E,R,T,Y...etc.");
    if (special === true && numeric === true && lower === true && upper === true) {
        ...
        var randomChar = finalArray[Math.floor(Math.random()*finalArray.length)];
